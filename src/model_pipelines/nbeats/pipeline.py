...
from model_pipelines.nbeats.core import train_nbeats, predict_nbeats, generate_nbeats_figure
from model_pipelines.utils.data import prepare_modelready_if_missing, resolve_data_path


def main() -> None:
    parser = argparse.ArgumentParser(description="End-to-end N-BEATS data prep, train, predict, and PNG generation")
