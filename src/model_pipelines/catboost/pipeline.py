...
def main() -> None:
    parser = argparse.ArgumentParser(description="Data prep + train/predict for CatBoost")
    ...
    parser.add_argument("--output-dir", default="src/models/benchmark_artifacts/catboost")
    ...
    pred_out = os.path.join(args.output_dir, "predictions_catboost.csv")
