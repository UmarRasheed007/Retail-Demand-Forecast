...
def main() -> None:
    parser = argparse.ArgumentParser(description="Data prep + train/predict for ExtraTrees")
    parser.add_argument("--split", choices=["train", "eval"], default="train")
    parser.add_argument("--batch-size", type=int, default=12000)
    parser.add_argument("--flat-dir", default="data/flattened_chunks")
    parser.add_argument("--daily-path", default="data/daily_dataset/daily_df_imputed.parquet")
    ...
    parser.add_argument("--output-dir", default="src/models/benchmark_artifacts/extra_trees")
    ...
    pred_out = os.path.join(args.output_dir, "predictions_extra_trees.csv")
