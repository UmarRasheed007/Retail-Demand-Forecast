...
def main() -> None:
    parser = argparse.ArgumentParser(description="Data prep + train/predict for GBR")
    ...
    parser.add_argument("--output-dir", default="src/models/benchmark_artifacts/gbr")
    ...
    pred_out = os.path.join(args.output_dir, "predictions_gbr.csv")
