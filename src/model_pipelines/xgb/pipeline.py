...
def main() -> None:
    parser = argparse.ArgumentParser(description="Data prep + train/predict for XGB")
    ...
    parser.add_argument("--output-dir", default="src/models/benchmark_artifacts/xgb")
    ...
    pred_out = os.path.join(args.output_dir, "predictions_xgb.csv")
